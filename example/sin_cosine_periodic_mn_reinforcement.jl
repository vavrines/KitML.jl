...
metaIter = 1
    ...
    begin
        ...
        for j = 1:nx
            for i = 1:ny
                ...
                phi[2, i, j] = 1.0/3.0 * phi[1, i, j]
                phi[3, i, j] = 1.0/3.0 * phi[1, i, j]
                phi[4, i, j] = 1.0/3.0 * phi[1, i, j]
    ...
    for iter in 1:1
        ...
        if errorsFound
            ...
            model.fit(phiTrainMat,hTrainMat,epochs =20,batch_size = 64,validation_split=0.0,verbose= 0)
